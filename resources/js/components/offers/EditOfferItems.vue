        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" @click="editItem"><i class="fa fa-save"></i>{{$t('Offer.save')}}</button>
                </div>
                <div class="card">
                  <div class="card-body">
                      ...
                      <tbody>
                        ...
                        <template v-else>
                          <tr v-for="selectedItem in selectedItems" :key="selectedItem.id">
                            ...
                            <td width="5%" class="align-middle">{{selectedItem.total}}</td>
                            <td width="5%" class="align-middle"><button type="button" class="btn btn-primary" @click="deleteItem"><i class="fa fa-trash"></i></button></td>
                          </tr>
                          <tr>
...
export default {
    ...
    methods: {
      editItem() {
        this.$emit('click-to-edit-items', this.selectedItems)
