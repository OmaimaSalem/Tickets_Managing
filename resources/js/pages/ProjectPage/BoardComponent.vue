<template>
  <div class="board row justify-content-center" v-if="!loading">
    <template v-if="board.board.length < 1">
      <div class="col-sm-12">
        <div class="alert alert-secondary">{{$t('Project.noTask')}}</div>
      </div>
    </template>
    <template v-else>
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-tools">
              ...
              >
                <i class="fas fa-info fa-fw"></i> {{$t('Project.default')}}
              </router-link>
            </div>
          </div>
          <div class="card-body">
                ...
                <div class="card bg-light">
                  ...
                  <div class="card-footer p-2">
                    <input
                      ...
                      :placeholder="$t('Project.enterNewTask')"
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="newTaskLabel">{{$t('Project.editTask')}}</h5>
              ...
              <form @submit.prevent="editTask(form)" @keydown="form.onKeydown($event)">
                <div class="modal-body">
                  <div class="form-group">
                    <label for="name">{{$t('Project.taskName')}}</label>
                    <input
                      v-model="form.name"
                      type="text"
                      name="name"
                  ...
                  <div class="form-group">
                    <label for="description">{{$t('Project.taskDesc')}}</label>
                    <quill-editor
                      id="comments-editor"
                  ...
                  <div class="form-group">
                    <label for="name">{{$t('Project.responsible')}}</label>
                    <multiselect
                  ...
                  <div class="form-group" v-if="form.priority">
                    <label for="priority">{{$t('Project.priorty')}}</label>
                    <multiselect
                      class="clearfix"
                  ...
                  <div class="form-group">
                    <label for="deadline">{{$t('Project.deadline')}}</label>
                    <date-picker
