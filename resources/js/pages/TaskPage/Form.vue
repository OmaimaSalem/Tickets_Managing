<template>
        ...
        <div class="card-body">
          <form @submit.prevent="editTask(form)" @keydown="form.onKeydown($event)">
            <div class="row">
              ...
              <div class="form-group col-sm-12 col-md-3">
                <label for="name">{{$t('Task.project')}}</label>
                <multiselect
            ...
            <div class="row">
              <div class="form-group col-sm-12 col-md-3" v-if="form.project.tickets">
                <label for="name">{{$t('Task.ticket')}}</label>
                <multiselect
                  v-model="form.ticket"
              ...
              <div class="form-group col-sm-12">
                <button type="submit" class="btn btn-success float-right">{{$t('Task.update')}}</button>
              </div>
              <div class="form-group col-sm-12 col-md-3">
  ...
  <div class="card" v-else>
    <div class="card-body justify-content-center">{{$t('Task.loading')}}</div>
  </div>
</template>
