...
class StatusTicketNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ->line("Ticket ".$this->ticket->name." status changed to ".$this->ticket->ticket_status->name." by ".$this->current_user->name)
    ...
    {
        return [
            'notification'     => "Ticket ".$this->ticket->name." status changed to ".$this->ticket->ticket_status->name." by ".$this->current_user->name,
