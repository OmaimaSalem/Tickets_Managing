...
class UpdateTicketNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ->line("Some changes have done in ".$this->ticket->name." ticket by ".$this->current_user->name)
    ...
    {
        return [
            'notification'     => "Some changes have done in ".$this->ticket->name." ticket by ".$this->current_user->name,
