...
class SpamTicketNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ->line("Ticket ".$this->ticket->name." add to spam by ".$this->current_user->name)
    ...
    {
        return [
            'notification'     => "Ticket ".$this->ticket->name." add to spam by ".$this->current_user->name,
